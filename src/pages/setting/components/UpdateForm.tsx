...
import { modifySetting, querySettingById } from '../../../api/SettingController';
...
export async function settingLoader({ params }: any) {
  const { data: { product } } = await querySettingById(params.id);
  return { product };
}
